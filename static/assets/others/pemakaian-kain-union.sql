...
FROM (
	...
	where
		...
		and b.created_at >= '2025-10-01 00:00:00' and b.created_at <= '2025-10-31 23:59:59'
	group by
		b.id
	UNION ALL 
	select
	...
	where
		id_item is not null
		and form_cut_piping.created_at >= '2025-10-01 00:00:00' and form_cut_piping.created_at <= '2025-10-31 23:59:59'
	group by
		form_cut_piping.id
	UNION ALL
	SELECT 
	...
	WHERE
		...
		and form_cut_piece_detail.created_at >= '2025-10-01 00:00:00' and form_cut_piece_detail.created_at <= '2025-10-31 23:59:59'
	GROUP BY
